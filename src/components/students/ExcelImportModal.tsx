...
function downloadTemplate(sections: Section[]) {
  ...
  const sample = [
    ['2025010', 'Maria', 'C.', 'Santos', sections[0]?.section_id ?? 1],
    ['2025011', 'Jose',  '',  'Reyes',   sections[1]?.section_id ?? 2],
  ];
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-xl border border-blue-100 bg-blue-50 p-4 flex items-start gap-3">
            ...
            <div className="flex-1 text-xs text-blue-700">
              <p className="font-semibold mb-1">Required columns: <code>student_number, first_name, last_name, section_id</code></p>
            ...
            <div className="max-h-72 overflow-auto rounded-xl border border-slate-200">
              <table className="min-w-full text-xs">
                <thead className="sticky top-0 bg-slate-100 z-10">
                  <tr>
                    {['#', 'Student No.', 'First Name', 'M.I.', 'Last Name', 'Section'].map(h => (
